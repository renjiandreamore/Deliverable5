...
//	for (int j = 0; j < _maxSize; j++) { //10000
...
//	}
    	/*
    	 *it doesn't need to be repeat for 10000 times,
    	 *whatever you got in getText(), you only get its first text
    	 *so do not need the loop 
    	 */
    	String toReturn = getText(); //get the botton's text for just one time
